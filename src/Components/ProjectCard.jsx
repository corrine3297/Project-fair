  ...
  return (
    ...
    <Modal size='lg' show={show} onHide={handleClose}>
        ...
        <Modal.Body>
            ...
            <div className="mt-3">
                <a href="https://github.com/ashishsamuel/netflix.git" target='_blank' className='me-3 btn'><i class="fa-brands fa-github fa-2x"></i></a>
                <a href="https://netflix-7a546.netlify.app/" target='_blank' className='me-5 btn'><i class="fa-solid fa-link fa-2x"></i></a>
            </div>
        </Modal.Body>
      </Modal>
    </>
